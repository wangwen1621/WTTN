...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='TransTimesNet')

    # basic config
    parser.add_argument('--is_training', type=int, required=True, default=1, help='status')
    parser.add_argument('--model_id', type=str, required=True, default='test', help='model id')
    parser.add_argument('--model', type=str, required=True, default='TransTimesNet',
                        help='model name')

    # data loader
    parser.add_argument('--data', type=str, required=True, default='runoff', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data/shuju/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='hht.csv', help='data file')
    ...
    parser.add_argument('--moving_avg', type=int, default=25, help='移动平均线的窗口大小')
    ...
    if args.is_training:
        ...
        setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(
            args.task_name, args.model_id, args.model, args.data, args.features, args.seq_len, args.label_len,  args.pred_len,
            args.d_model, args.n_heads, args.e_layers, args.d_layers, args.d_ff, args.factor, args.embed, args.distil, args.des, ii)
...
print("Total Runtime of the Program:",toc-tic)